...
options = {
    {
        ...
        onSelect = function(data)
            ...
            }) then TriggerServerEvent('nfire_hunting:harvestCarcass',NetworkGetNetworkIdFromEntity(data.entity),bone) end
        end,
		...
		options = {
			{
				...
				onSelect = function ()
                    ...
                    }) then TriggerServerEvent('nfire_hunting:SellCarcass', Config.carcass[heaviestCarcass]) end
                end,
